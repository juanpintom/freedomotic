 ...
 */
package com.freedomotic.plugins.devices.serial;
...
public class Serial extends Protocol implements SerialDataConsumer {
    ...
    public Serial() {
        super("Serial", "/serial/serial-manifest.xml");
